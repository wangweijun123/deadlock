...
Java_com_darren_optimize_day13_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_darren_optimize_day13_NativeThreadMonitor_getContentThreadId(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_darren_optimize_day13_NativeThreadMonitor_nativeInit(JNIEnv *env, jclass clazz,
                                                              jint sdk_version) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_darren_optimize_day13_NativeThreadMonitor_getCurrentThreadId(JNIEnv *env, jclass clazz,
                                                                      jlong thread_native_address,
                                                                      jint sdk_version) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_darren_optimize_day13_NativeThreadMonitor_monitorThread(JNIEnv *env, jclass clazz) {
